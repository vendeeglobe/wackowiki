...
$wacko_translation = [
	...
	'GeoLink'					=> '显示此位置(地图应用启动)',
	'JabberLink'				=> '通过 XMPP 聊天 （Jabber 客户端启动）',
	'TelLink'					=> '呼叫此号码 (手机应用启动)',
	'PermaLink'					=> '永久链接',
	...
	'ByteDecimalLong'			=> ['字节', 'Kb', 'Mb', 'Gb', 'Tb', 'Pb', 'Eb', 'Zb', 'Yb'],
	'ByteBinaryShort'			=> ['B', 'Kb', 'Mb', 'Gb', 'Tb', 'Pb', 'Eb', 'Zb', 'Yb'],
	'ByteBinaryLong'			=> ['字节', 'Kb', 'Mb', 'Gb', 'Tb', 'Pb', 'Eb', 'Zb', 'Yb'],
