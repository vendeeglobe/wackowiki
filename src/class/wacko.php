	...
	function load_user($user_name, $user_id = 0): ?array
	{
		return $this->db->load_single(
			'SELECT
				...
				s.editor_height, s.autosave_draft, s.dark_mode, s.syntax_highlighting, s.live_preview, s.noid_pubs, s.session_length,
				s.timezone, s.date_preference, s.sorting_comments, s.comments_offset ' .
