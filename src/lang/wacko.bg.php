...
$wacko_translation = [
	...
	'GeoLink'					=> 'Показване на това местоположение (стартиране на приложение за карта)',
	'JabberLink'				=> 'Chat via XMPP (Jabber client launch)',
	'TelLink'					=> 'Обаждане на този номер (стартиране на приложение за телефон)',
	'PermaLink'					=> 'Постоянна препратка',
	'PermaLinkTip'				=> 'Постоянна препратка към тази версия на страницата',
	'PermaLink0Tip'				=> 'Постоянна препратка към тази страницата',
	...
	'Comments'					=> 'Коментари',
	'CommentHint'				=> '<a href="%1">Влезте</a> или <a href="%2">създайте акаунт</a>, за да публикувате коментар.',
	...
	'TextDbOversize'			=> 'Внимание: Вашият текст надхвърля ограничението за дължина с %1 символа. Моля, съкратете текста си до разумен брой знаци. Съвет: Можете да поставите останалия текст на отделна страница.',
	...
	'RemoveComment'				=> 'Click here to delete comment.',
	'RemoveCluster'				=> 'Remove all pages of the cluster',
	'RemoveDontKeep'			=> 'Do not save a copy of a removed page and comments',
	'RemoveDontKeepPurge'		=> 'Не запазвайте копие на премахнатите файлове, редакции и коментари',
	...
	'OrderCreation'				=> 'сортиране по начална дата',
	...
	'SearchInNoOption'			=> 'Трябва да изберете поне една от опциите за търсене.',
	...
	'IntercomDesc'				=> 'Бележка: Изпращане на лични съобщения до имейл адреса на получателя, без да се разкрива вашият адрес. Получателят има възможност да ви отговори, като използва същия формуляр на страницата на профила ви. ',
	'PMOversized'				=> 'Дължината на съобщението надвишава максималния размер с %1. Моля, съкратете съобщението си и го изпратете отново.',
